...
I'd like to clear some things that you might wanna know.

No, I did not make any of these scripts. These scripts are entirely skidded and if you want to find the original owners, just look up the original script's name.

(they'll be on mastersMZ or dark eccentric's channel)

This isn't a beta of Premium. None of the premium scripts are in this hub, due to Premium being paid, I'd prefer not to skid something I'm gonna sell.
...
Tab:Button{
	Name = "FE Rocket (script and hats: controlc.com/e7ba7a7a",
	Description = nil,
	Callback = function() game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 20
...
Tab:Button{
	Name = "FE Gaming Setup (hats: https://pastebin.com/raw/XjdFXGdw)",
	Description = nil,
	Callback = function() loadstring(game:HttpGetAsync('https://pastebin.com/raw/zKQX7w2m'))() end
}

Tab:Button{
	Name = "FE Moai (hats: controlc.com/e10d383c)",
	Description = nil,
	Callback = function() loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/kdm05/releases/main/Moai.lua'))() end
}


Tab:Button{
	Name = "FE Dinosaur (hats: nike shoe box)",
	Description = nil,
	Callback = function() loadstring(game:HttpGet('https://paste.ee/r/gQOXW', true))() end
}
